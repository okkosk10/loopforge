...
```
AI / GPT
  -> generates sprite sheet PNG  (recommended: 4x4, transparent bg, no labels)
...
- **Empty cell skip** - skips fully transparent cells when a generated sheet has unused slots
...
1. **Sprite slicing polish** - duplicate-frame detection and stronger diagnostics for unusual grids
...
4. **Frame trimming** - transparent padding crop controls for manual frame imports
